...
final class DecodeHandler extends Handler {
	...
	public void handleMessage(Message message) {
		...
		switch (message.what) {
			case com.fgtit.fingerprintapp.R.id.decode:
				decode((byte[]) message.obj, message.arg1, message.arg2);
				break;
			case com.fgtit.fingerprintapp.R.id.quit:
				running = false;
		...
		if (rawResult != null) {
			...
			if (handler != null) {
				Message message = Message.obtain(handler,
						com.fgtit.fingerprintapp.R.id.decode_succeeded, rawResult);
			...
			if (handler != null) {
				Message message = Message.obtain(handler, com.fgtit.fingerprintapp.R.id.decode_failed);
				message.sendToTarget();
			}
		}
	}
